...
def train(args, model, device, train_loader, optimizer, epoch):
    print("Loss weights: ", args['alpha'], 1 - args['alpha'])
    model.train()
    num_loss = 0
    col_loss = 0
    num_correct_count = 0
...
def test(args, model, device, test_loader, held_out, control):
    ...
    # print("9 pct:", nines_correct, "/", nines_count)
    total_loss = num_loss + col_loss
    ...
    for keep_pct in keep_pcts:
        ...
        if args['weighted'] and args['alpha'] is None:
            ...
            if isinstance(weight, collections.Mapping):
                ...
                args['alpha'] = weight[str(keep_pct)]
        ...
        for epoch in range(1, args['epochs'] + 1):
            ...
            keep_pct_test_results.append(
                test(args, model, device, test_loader, train_loader.dataset.held_out_test, train_loader.dataset.control_test))
