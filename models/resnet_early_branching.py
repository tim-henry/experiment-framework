...
def ResNet18(pretrained=False, fine_tune=False, num_classes=(10, 10), pool=True, branching=True):
    # print("Pretrained? ", pretrained)
    model = ResNet(BasicBlock, [2, 2, 2, 2], fine_tune=fine_tune, classes=num_classes, pool=pool, pretrained=pretrained, branching=branching)
