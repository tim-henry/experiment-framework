...
options = {
    ...
    "resnet_with_pool_pretrained_embeddings": lambda num_classes: models.multitask_resnet.ResNet18(pretrained=False,
                                                                                                   fine_tune=True,
                                                                                                   classes=num_classes),
    "resnet_no_pool": lambda num_classes: models.multitask_resnet.ResNet18(pretrained=False,
                                                                             fine_tune=True,
                                                                             classes=num_classes,
                                                                           pool=False),
    "resnet_no_pool_pretrained": lambda num_classes: models.multitask_resnet.ResNet18(pretrained=False,
                                                                                        fine_tune=True,
                                                                                        classes=num_classes,
                                                                                      pool=False),
    "resnet_no_pool_pretrained_embeddings": lambda num_classes: models.multitask_resnet.ResNet18(pretrained=False,
                                                                                                   fine_tune=True,
                                                                                                   classes=num_classes,
                                                                                                   pool=False),
}
