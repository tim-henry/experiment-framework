...
def keep_pct_readout_dump(timestamp, output_values, dataset=None, modelname=None, experiment=None):
    ...
    if "state_dict" in output_values:
        directory = "analysis/state_dicts/" + dataset + "/" + experiment + "/" + modelname + "/"
